 ...
 * 自己开发一个电视----流媒体之JavaCV
 * <p>
 * https://cloud.tencent.com/developer/article/1840293?from=15425
 */
public class TVExamples {
    ...
    public static void recordTV(String rtmpUrl) throws Exception {
        ...
        //打开抓取器
        grabber.start();
        CanvasFrame canvas = new CanvasFrame("fengyp");
        //关闭窗口的时候停止程序
    ...
    public static void main(String[] args) throws Exception {
        recordTV("https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8");
